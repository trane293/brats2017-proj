...
config['hdf5_combined'] = os.path.join(os.sep.join(config['hdf5_filepath_prefix'].split(os.sep)[0:-1]), 'BRATS_Combined.h5')
...
config['num_patches_per_patient'] = 4 # number of patches to generate for a single patient
config['patch_size'] = [128, 128, 128] # size of patch to extract
