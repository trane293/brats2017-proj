...
reduceLR = ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=3, verbose=1, mode='auto', epsilon=0.01, cooldown=0, min_lr=0.0001)
...
# TODO: Implement another version of this generator to generate patches according to the input shapes that the network expects
...
# TODO: Implement save model with yper and history function inside the model file.
